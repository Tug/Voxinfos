...
public class TreeSet extends AbstractCollection implements SortedSet
{
    ...
    public void serialize(DataOutput output) throws IOException {
        ...
        while(it.hasNext()) {
            Serializable sObj = (Serializable) it.next();
    ...
    public void deserialize(DataInput input) throws IOException {
        ...
        for(int i=0; i<size; i++) {
            add(Serializer.deserializeClass(input));
        }
    }
    ...
    private static class AANode implements Serializable
    {
        ...
        public void serialize(DataOutput output) throws IOException {
            Serializer.serializeClass((Serializable) element, output);
        }

        public void deserialize(DataInput input) throws IOException {
            this.element = (Serializable) Serializer.deserializeClass(input);
        }
